...
(ConvexHullGrahamScan.prototype = {
  ...
  addPoint: function(a, b) {
    var c =
      ...
      this.anchorPoint.y > b ||
      (this.anchorPoint.y === b && this.anchorPoint.x > a);
    c
      ? (void 0 !== this.anchorPoint &&
          this.points.push(
  ...
  getHull: function() {
    var a,
      ...
      c = [];
    if (
      ((this.reverse = this.points.every(function(a) {
        return a.x < 0 && a.y < 0;
      })),
      (a = this._sortPoints()),
      (b = a.length),
      ...
      return a.unshift(this.anchorPoint), a;
    for (c.push(a.shift(), a.shift()); ; ) {
      ...
      if (
        ...
        (e = c[c.length - 2]),
        (f = c[c.length - 1]),
        this._checkPoints(d, e, f) && c.splice(c.length - 2, 1),
        0 == a.length)
      ) {
        if (b == c.length) {
